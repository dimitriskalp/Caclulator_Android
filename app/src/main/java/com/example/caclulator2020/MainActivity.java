package com.example.caclulator2020;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newNumber = findViewById(R.id.newText);
        ...
        View.OnClickListener listener1 = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newNumber.append(buttonClicked.getText()); // take the number from the text of the button
        ...
        buttonDot.setOnClickListener(listener1); // put the listener in every button to use the same method
        ...
        View.OnClickListener operationListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                  ...
                  performOperation(newValueDouble, operation); //here is the calculation
